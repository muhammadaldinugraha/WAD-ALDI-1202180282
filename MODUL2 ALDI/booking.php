...
<body>
    ...
    <div class="main">
        <div class="row content">
            ...
            <div class="col-sm-5 kiri">
                <div class="p-5">
                    <form method="post" action="mybooking.php">
                        ...
                        <div class="form-group">
                            <label for="inDate" class="col-sm-4 col-form-label">Check-In</label>
                            <div class="col-sm-12">
            ...
            <div class="col-sm-6 kanan px-4">
                <div class="container">
                    <div class="img-card">
                        <?php
                        if (empty($_GET['img'])) {
                            echo '<img class="img-fluid roomPreview prev" src="./gambar/hotel1.jpg" alt="Pr">';
                        } else {
                            echo '<img class="img-fluid roomPreview prev" src="./gambar/' . $_GET['img'] . '.jpg" alt="">';
                        }
                        ?>
                    </div>
